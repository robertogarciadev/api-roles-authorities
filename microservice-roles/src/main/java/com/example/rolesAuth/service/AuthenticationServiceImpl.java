...
public class AuthenticationServiceImpl implements AuthenticationService {
     ...
     */
    @Override
    public Optional<UserJWTDTO> singInAndReturnJWT(UserLoginDTO dto) {

        // Por debajo de esta operación ocurre:
        // Buscar al usuario en la BD (mediante tu CustomUserDetailsService).
        // Verificar que la contraseña que llegó (dto.getPassword()) coincide con la
        // almacenada (después de aplicar el PasswordEncoder).
